...
import { DenyFriendshipRequestCommand } from '@UserRelation/cqrs/commands/deny-friendship-request/deny-friendship-request.command';

@CommandHandler(DenyFriendshipRequestCommand)
class DenyFriendshipRequestService implements ICommandHandler {
  constructor(
...
export { DenyFriendshipRequestService };
