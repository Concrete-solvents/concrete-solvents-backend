...
import { ApproveFriendshipRequestCommand } from '@UserRelation/cqrs/commands/approve-friendship-request/approve-friendship-request.command';

@CommandHandler(ApproveFriendshipRequestCommand)
class ApproveFriendshipRequestService implements ICommandHandler {
  constructor(
...
export { ApproveFriendshipRequestService };
