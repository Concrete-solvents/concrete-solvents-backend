...
// UserRelation
import { GetUserRelationsQuery } from '@UserRelation/cqrs/queries/get-user-relations/get-user-relations.query';
...
class GetUserRelationsApplicationService implements IQueryHandler {
  constructor(
...
export { GetUserRelationsApplicationService };
